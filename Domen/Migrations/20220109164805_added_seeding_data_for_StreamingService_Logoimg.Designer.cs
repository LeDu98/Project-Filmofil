...
namespace Domen.Migrations
{
    ...
    [Migration("20220109164805_added_seeding_data_for_StreamingService_Logoimg")]
    partial class added_seeding_data_for_StreamingService_Logoimg
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoviePersonnel", b =>
                {
                    b.Property<int>("MoviesMovieId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("MoviesMovieId", "PersonnelsPersonnelId");
            ...
            modelBuilder.Entity("ActorMovie", b =>
                {
                    b.HasOne("Domen.Actor", null)
                        .WithMany()
                        .HasForeignKey("ActorsActorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domen.Movie", null)
                        .WithMany()
